    ...
    <div className=' w-full vh-screen bg-black relative '>
      ...
      <div className=' w-full h-full absolute top-0 left-0 bg-black opacity-70 '></div>
        ...
        <div className=' absolute top-1/2 left-1/2 -translate-1/2 text-center '>
            ...
            <p className='text-base lg:text-lg mt-5 w-full text-[#A0A4A1] px-1 lg:px-2 font-DM-Sans '>{normalText1}<span className=' gradient-text '>{gradientText1}</span> {normalText2}<span className=' gradient-text '>{gradientText2}</span>{normalText3}</p>
        </div>
    </div>
  )
}
