...
const HeroSection = () => {
  ...
  return (
    <div className='w-full min-h-screen relative'>
      ...
      >
        <div className='w-full z-10 min-h-[50vh] relative flex flex-col justify-center items-center gap-5'>
          <h1 className='font-cervino text-6xl font-extrabold leading-16 text-[#1C2546] text-center'>
      ...
      >
        ...
        {/* Center Slider Card */}
        <div className='w-[300px] h-[300px] rounded-2xl absolute top-10 left-1/2 -translate-x-1/2'>

          <div className='absolute w-[220px] h-[50px] right-11/12 bottom-10 flex justify-center items-center z-10'>
        ...
        {/* Floating Cards */}
        <div className='w-[200px] h-[200px] absolute top-0 left-[23%] -translate-x-[23%]'>
        ...
        <div className='w-[150px] h-[150px] absolute top-5 right-[22%] -translate-x-[22%] z-10'>
          ...
          <div className='absolute w-[200px] h-[50px] left-11/12 top-0 flex justify-center items-center'> <div className='flex justify-center items-center gap-2.5'> <div className='w-[10px] h-[10px] rounded-full bg-white animate-ping'></div> <div className='w-[185px] bg-gradient-to-r from-[#407ff5bb] to-[#582ac2c5] text-white py-1 px-2 rounded-2xl text-center font-cervino'> Privacy-First AI </div> </div> </div>
        </div>

        <div className='w-[150px] h-[150px] absolute bottom-10 right-1/6'>
        ...
        <div className='w-[100px] h-[100px] absolute top-16 right-[150px]'>
        ...
        <div className='w-[100px] h-[100px] absolute bottom-16 left-[150px]'>
