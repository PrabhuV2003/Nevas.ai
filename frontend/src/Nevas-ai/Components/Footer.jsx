  ...
  return (
    <div className='w-full py-3 px-5 flex flex-col justify-between md:py-5 md:px-10 relative overflow-hidden bg-black ' style={{ height: "calc(var(--vh) * 100)" }}>
      ...
      <motion.div
        ...
        className=' absolute top-1/2 left-1/2 -translate-x-1/2  z-40 h-full mt-4 md:mt-0 '
      >
        <button onClick={onNewsletterClick} className=' px-5 py-2 border border-primay rounded-full text-white bg-transparent hover:bg-gradient-to-r hover:from-primay hover:to-secoundary transition-all duration-500 cursor-pointer text-sm md:text-[22px]'>
          News Letter
        </button>
      </motion.div>
